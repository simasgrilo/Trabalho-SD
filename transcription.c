...
char* aminoacids(char *in, int size){
    ...
    else if(in[0] == 'C' && in[1] == 'U'){
    	if(in[2] == 'C' || in[2] == 'A' || in[2] == 'U' || in[2] == 'G')
        	return  "Leu";
    }
    else if(in[0] == 'A' && in[1] == 'U'){
        if(in[2] == 'U' || in[2] == 'C') return  "Leu";
        else if (in[2] == 'A' || in[2] == 'G') return  "Met";
    }
    else if(in[0] == 'G' && in[1] == 'U'){
		if(in[2] == 'U' || in[2] == 'C' || in[2] == 'A' || in[2] == 'G')
 		return  "Val";
	}
        //fim da primeira coluna
    else if(in[0] == 'U' && in[1] == 'C'){
		if(in[2] == 'U' || in[2] == 'C' || in[2] == 'A' || in[2] == 'G')
 			return  "Ser";
	}
    else if(in[0] == 'C' && in[1] == 'C'){
		if(in[2] == 'U' || in[2] == 'C' || in[2] == 'A' || in[2] == 'G')
    		return  "Pro";
	}
